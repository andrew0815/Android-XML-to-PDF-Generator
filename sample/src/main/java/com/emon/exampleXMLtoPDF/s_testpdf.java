...
public class s_testpdf extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.s);
        ...
        Containers=findViewById(R.id.contenerdoreporte);


        btncreatepdf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bitmap=LoadBitmap(Containers,Containers.getWidth(),Containers.getHeight());
                createPdf();
            }
        });
