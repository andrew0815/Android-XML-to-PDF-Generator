...
public class test2pdf extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test2pdf);
        btncreatepdf=findViewById(R.id.buttonpdf);
        PrincipalContainer=findViewById(R.id.container);
